...
public final class TestSecureOzoneCluster {
  ...
  public void testDelegationToken() throws Exception {
    ...
    try {
      ...
      Assert.assertFalse(logs.getOutput().contains("Auth successful for "
          + username + " (auth:KERBEROS)"));
      ...
      UserGroupInformation testUser = UserGroupInformation.createRemoteUser(
          TEST_USER);
      ...
      omClient = new OzoneManagerProtocolClientSideTranslatorPB(RPC.getProxy(
          OzoneManagerProtocolPB.class, omVersion, OmUtils.getOmAddress(conf),
          testUser, conf, NetUtils.getDefaultSocketFactory(conf),
          Client.getRpcTimeout(conf)));
  ...
  public void testDelegationTokenRenewal() throws Exception {
    ...
    try {
      ...
      omClient = new OzoneManagerProtocolClientSideTranslatorPB(RPC.getProxy(
          OzoneManagerProtocolPB.class, omVersion, OmUtils.getOmAddress(conf),
          ugi, conf, NetUtils.getDefaultSocketFactory(conf), CLIENT_TIMEOUT));
